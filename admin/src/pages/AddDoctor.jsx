...
const AddDoctor = () => {
  ...
  const handleChange = (e) => {
    ...
    // Validation for PIN Code to only allow numbers
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        `${import.meta.env.VITE_BACKEND_URI}/api/admin/add-doctor`, 
        submitData,
        {
          headers: {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-6">
                ...
                <div className="space-y-3">
                  <h4 className="text-sm font-medium text-gray-700 mb-2">Clinic Address</h4>
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    ...
                    <div>
                      ...
                      <input
                        ...
                        onChange={handleChange}
                        required
                        placeholder="e.g. Medical Avenue"
                        className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                      />
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      required
                      placeholder="e.g. Health District"
                      className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    />
                    <p className="mt-1 text-sm text-gray-500">Help patients locate your clinic easily</p>
                  </div>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      className="block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"
                    />
                    <p className="mt-1 text-sm text-gray-500">6-digit PIN code</p>
                  </div>
                </div>
              </div>
            </div>
